  ...
  return (
    <div>
      <div className='absolute top-0 left-0 h-full w-full p-10 flex flex-col justify-between'>
        ...
        <div>
            <p className='text-lg leading-relaxed text-white mb-14'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident quod amet quis officia libero deleniti!</p>
